  ...
  const renderSocialIcons = () => {
    return (
      <div className="flex flex-row items-center space-x-8">
        <a
          href="https://www.facebook.com/womenforchangeSA"
          target="_blank"
        ...
        <a
          href="https://twitter.com/womenforchange5"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.tiktok.com/@womenforchange.sa"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className=" bg-[var(--color-primary)] h-14 w-14 rounded-full flex items-center justify-center">
        ...
        <a
          href="https://www.instagram.com/womenforchangesa/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <div className=" bg-[var(--color-primary)] h-14 w-14 rounded-full flex items-center justify-center">
