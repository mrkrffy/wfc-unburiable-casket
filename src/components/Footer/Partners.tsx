  ...
  const renderPartnersLogos = () => {
    return (
      <div className="lg:mt-20 mt-15 grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-y-14 justify-items-center px-[10vw]">
        <div className="flex flex-col space-y-2 items-center">
          ...
          >
            <img
              src={amaziSheTribe}
              alt="Amazi SHEtribe"
              className="lg:h-18 h-16 w-auto"
            />
          </a>
        </div>
        <div className="flex flex-col space-y-2 items-center">
          <p className="text-white">Casket:</p>
          <a
            href="https://enzowooddesign.co.za/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={enzoLogo}
              alt="Enzo Wood Designs"
              className="lg:h-18 h-16 w-auto"
            />
          </a>
        </div>
        ...
        <div className="flex flex-col space-y-2 items-center">
          <p className="text-white">Herse:</p>
          <a
            href="https://randfunerals.co.za/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={randFuneralsLogo}
              alt="Rand Funerals"
              className="lg:h-18 h-16 w-auto"
            />
          </a>
        ...
        <div className="flex flex-col space-y-2 items-center">
          <p className="text-white">Creative and PR:</p>
          <a
        ...
        <div className="flex flex-col space-y-2 items-center">
          ...
          <a
            href="https://imprintmedia.co.za/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={imprintMediaLogo}
              alt="Imprint Media"
              className="lg:h-18 h-16 w-auto"
            />
          </a>
        ...
        <div className="flex flex-col space-y-2 items-center">
          ...
          <a
            href="https://www.bigbrave.digital/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={bigBraveLogo}
              alt="Big Brave Digital"
              className="lg:h-18 h-16 w-auto"
            />
          </a>
        </div>
